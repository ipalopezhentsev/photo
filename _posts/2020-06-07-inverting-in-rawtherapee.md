...
1. Assign flat field file to it. In order to do this, go to `Raw -> Flat field -> File` and choose the file from the group *"Frames FF"* you shot before, that has the same aperture as *"Frame FB"*. [Here](/photo/assets/images/articles/inverting-in-rt/) you can download my flat field.
