...
In the process I've ditched the Plustek and switched to DSLR scanning using Nikon D750/macro lens/home built scanning rig. I thought I was doing fine until I noticed that, if I was being honest with myself, colors on my conversions looked bad and different software from the list above, while giving different results, provided just different shades of mediocrity (if I may cite Simon & Garfunkel!). It's not that I was ignorant and didn't read their manuals/forums/tutorials. When you spent money on it, for sure you try to study them better.
...
- All the edits you do are non-destructive, the image inside stays just the same non-inverted raw. All the processing settings are stored in the sidecar human readable (and editable) text files. There's no any catalog involved, just the raw's and the sidecars.
...
1. Conversion stage, where you take the negative raw's and turn them to positives

For the conversion stage, I will give you my raw's so you can just follow along.
